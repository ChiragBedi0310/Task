...
namespace BusinessLayer
{
    ...
    public class ProductManagementIO
    {
        ...
        public byte Menu()
        {
            ...
            Console.WriteLine("Press 5 to Add Categpry");
            Console.WriteLine("Press 6 to View All Products With Categories");
            Console.WriteLine("Press 7 to Update Category");
            Console.WriteLine("Press 8 to Delete Category");
